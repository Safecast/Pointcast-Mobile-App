...
public:
    ...
    static void prepareChart(cocos2d::ui::Widget* p_chart_board_widget, scene::menu::Analytics* p_scene_analytics,
                                                  ...
                                                  const std::vector<lib::object::WeatherItem> v_weather_items, bool is_empty = false);
    
    static scene::chart::Board::Config getConfig(const std::vector<lib::object::ChartItem> &v_chart_items, const std::vector<lib::object::WeatherItem> &v_weather_items, scene::menu::Analytics* p_scene_analytics, int m_sensor_main_id, bool is_empty);
